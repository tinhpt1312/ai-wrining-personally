...
const DEFAULT_STATUS: Partial<Record<ErrorCode, HttpStatus>> = {
  ...
  [ERROR_CODE.BOOK_NOT_FOUND]: HttpStatus.NOT_FOUND,
  [ERROR_CODE.CHAPTER_NOT_FOUND]: HttpStatus.NOT_FOUND,
  [ERROR_CODE.BOOK_NO_CHAPTERS]: HttpStatus.NOT_FOUND,
  ...
  [ERROR_CODE.UNSUPPORTED_BOOK_FORMAT]: HttpStatus.UNSUPPORTED_MEDIA_TYPE,
  [ERROR_CODE.BOOK_FILE_TOO_LARGE]: HttpStatus.PAYLOAD_TOO_LARGE,
};
