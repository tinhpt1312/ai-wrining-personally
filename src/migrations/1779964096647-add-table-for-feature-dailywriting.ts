...
export class AddTableForFeatureDailywriting1779964096647 implements MigrationInterface {
  name = 'AddTableForFeatureDailywriting1779964096647';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "writing_suggestions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "writing_id" uuid NOT NULL, "type" character varying(100) NOT NULL, "original_text" text NOT NULL, "suggested_text" text NOT NULL, "explanation" text NOT NULL, "confidence_score" double precision NOT NULL DEFAULT '0.5', "is_applied" boolean NOT NULL DEFAULT false, "severity" character varying(50) NOT NULL DEFAULT 'info', "position" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f4efeb691a41aed04f8e12e8abe" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_stats" DROP CONSTRAINT "FK_0e0da843088caf61925ded4434e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "daily_tips" DROP CONSTRAINT "FK_429cf6e6ac9adc1774c7c56ce88"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "writing_suggestions"`);
    ...
    await queryRunner.query(`DROP TABLE "daily_tips"`);
